  ...
  return (
    <button
      ...
      className={clsx(
        ...
        focusActive
          ? 'border-brand-500 bg-gradient-to-br from-brand-200 to-brand-100 ring-1 ring-brand-300 dark:from-brand-500/30 dark:to-brand-500/15 dark:ring-brand-500/50'
