...
export function RichEditor({ value, onChange, placeholder }: Props) {
  ...
  const btn = 'rounded-lg p-1.5 text-slate-500 hover:bg-slate-100 active:scale-95'

  return (
    <div className="mt-1 rounded-xl border border-slate-200 focus-within:border-brand-600">
      ...
      <div
        ...
        className="rich-editor min-h-[88px] px-3 py-2 text-sm leading-relaxed text-slate-800 outline-none [&_ul]:list-disc [&_ol]:list-decimal [&_ul]:pl-5 [&_ol]:pl-5"
      />
    </div>
  )
}
