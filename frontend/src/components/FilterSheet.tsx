...
export function FilterSheet({
  ...
  return (
    <div className="fixed inset-0 z-40 flex flex-col justify-end">
      ...
      <div className="relative max-h-[82vh] overflow-y-auto rounded-t-3xl bg-white pb-[calc(env(safe-area-inset-bottom)+1rem)] shadow-2xl animate-slide-up">
        {/* grabber + header */}
          ...
          <div className="flex items-center justify-between pb-3">
            ...
            <div className="flex items-center gap-2">
              {count > 0 && (
                <button
                  onClick={onClear}
                  className="flex items-center gap-1 rounded-full px-2.5 py-1 text-sm font-medium text-brand-600 active:bg-brand-50"
                >
