  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex items-center gap-2">
        ...
        <span className="shrink-0 text-xs font-semibold text-slate-500 dark:text-slate-400">{p.progress}%</span>
      </div>
      ...
      <div className="mt-3 flex items-center justify-between text-xs">
        ...
        <span className="text-slate-400 dark:text-slate-500">Due {formatDate(p.deadline)}</span>
      </div>

      <div className="mt-3 flex items-center gap-4 border-t border-slate-100 dark:border-slate-800 pt-3 text-xs">
        <span className="flex items-center gap-1.5 text-slate-500 dark:text-slate-400">
          <Avatar name={p.owner_name} size={20} />
          <span className="text-slate-400 dark:text-slate-500">Owner</span>
          <span className="font-medium text-slate-600 dark:text-slate-300">{p.owner_name}</span>
        </span>
        <span className="flex items-center gap-1.5 text-slate-500">
          <Avatar name={p.leader_name} size={20} />
          <span className="text-slate-400 dark:text-slate-500">Lead</span>
          <span className="font-medium text-slate-600 dark:text-slate-300">{p.leader_name}</span>
        </span>
      </div>
    </button>
  )
