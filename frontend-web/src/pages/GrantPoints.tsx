...
import { Spinner, Avatar, Segmented } from '@/components/ui'
          ...
          <BentoTile span="full" tone="plain" title="Grant points">
            <div className="space-y-5 mt-1">
              ...
              <button
                type="submit"
                disabled={submitting}
                className="inline-flex items-center gap-2 rounded-xl bg-brand-600 px-5 py-2.5 text-sm font-semibold text-white hover:bg-brand-700 active:scale-[0.99] disabled:opacity-60 transition"
              >
