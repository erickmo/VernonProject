...
import { LogOut, KeyRound, Smartphone, Sparkles, Fingerprint, Trash2, Loader2, Wand2, Trophy, BookOpen, Wifi, WifiOff, RefreshCw, User, CalendarOff, ChevronRight, Rocket, Webhook, Copy } from 'lucide-react'
    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-4">
      ...
      <BentoGrid>
        ...
        <BentoTile span="md" tall tone="tint" accent="brand" title="Settings">
          ...
          <button
            onClick={() => b && navigate(`/superpowers/${encodeURIComponent(b.user)}`)}
            className="w-full flex items-center gap-3 px-5 py-3 text-sm text-left hover:bg-hover/[0.04] active:scale-[0.99]"
          >
