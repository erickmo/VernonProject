...
DISC_ITEMS = [
    ...
    {"id": "d6", "words": [{"text": 'Ekspresif', "axis": 'I'}, {"text": 'Setia', "axis": 'S'}, {"text": 'Teratur', "axis": 'C'}, {"text": 'Berani', "axis": 'D'}]},
    ...
    {"id": "d10", "words": [{"text": 'Ramah', "axis": 'I'}, {"text": 'Tenang', "axis": 'S'}, {"text": 'Teratur', "axis": 'C'}, {"text": 'Tegas', "axis": 'D'}]},
